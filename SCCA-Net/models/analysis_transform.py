...
class Analysis_transform(nn.Module):
    def __init__(self, num_filters=224):
        ...
        # i = 0
        self.b0_shortcut = nn.Conv2d(6, num_filters, 1, stride=2)
        self.b0_layer2 = nn.Conv2d(6, num_filters, 3, stride=2, padding=1)
...
if __name__ == "__main__":
    ...
    input_image = torch.zeros([1,6,256,256])
